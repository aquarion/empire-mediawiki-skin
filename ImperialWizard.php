...
class SkinImperialWizard extends SkinTemplate {
    ...
    function initPage( OutputPage $out ) {
            parent::initPage( $out );
            $this->skinname  = 'imperialwizard';
            $this->stylename = 'imperialwizard';
            $this->template  = 'ImperialWizardTemplate';
    }
    function setupSkinUserCss( OutputPage $out ) {
        //    parent::setupSkinUserCss( $out );
            ...
            $out->addStyle( 'imperialwizard/css/bootstrap.css', 'screen, print' );
            $out->addStyle( 'imperialwizard/css/bootstrap-responsive.css', 'screen, print' );
            $out->addStyle( 'imperialwizard/site.css', 'screen, print' );
			if(isset($wgSiteCSS)) {
